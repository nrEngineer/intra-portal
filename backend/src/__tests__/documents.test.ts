...
import { setupTestDb, resetTestDb, seedTestMember } from "./test-helpers.js";
...
describe("ドキュメント管理", () => {
  ...
  describe("ドキュメント", () => {
    ...
    it("ドキュメントを削除できる", async () => {
      const doc = await insertDocument({ title: "削除テスト", folderId: null, fileUrl: "https://r2/del.pdf", fileName: "del.pdf", fileSize: 100, createdBy: memberId });
